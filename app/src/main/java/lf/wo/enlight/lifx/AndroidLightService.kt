...
private fun LightEntity.toDefaultState(): DefaultLightState {
    return DefaultLightState(
            ...
            location = StateLocation(location.id.toTypedArray(), location.label.maxLengthPadNull(32).toByteArray(), location.updatedAt),
            group = StateGroup(group.id.toTypedArray(), group.label.maxLengthPadNull(32).toByteArray(), group.updatedAt),
